...
{
    public partial class frmDrugReport : Form
    {
        public frmDrugReport()
        {
            InitializeComponent();
        }
        ...
        DrugOrderReport rpt;
        public void PrintOrder(string clinicname, string clinicphone, string clinicaddress, string patientno, string docno, string examdate,
